        ...
        public void onUpgrade(Database db, int oldVersion, int newVersion) {
            ...
            try {
                ...
                String[] changesRequeriedByVersion6 = new String[]{
                        "ALTER TABLE " + SpotDao.TABLENAME + " ADD '" + SpotDao.Properties.IsNotHitchhikedFromHere.columnName + "' " + SpotDao.Properties.IsNotHitchhikedFromHere.type.getSimpleName() + " DEFAULT 0;"
                };
                String[] changesRequeriedByVersion7 = new String[]{
                        "ALTER TABLE " + SpotDao.TABLENAME + " ADD '" + SpotDao.Properties.AuthorUserName.columnName + "' " + SpotDao.Properties.AuthorUserName.type.getSimpleName() + ";"
                };
                ...
                versionsUpdate.add(changesRequeriedByVersion7);
