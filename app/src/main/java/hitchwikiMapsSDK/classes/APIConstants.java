...
public class APIConstants {
    public static String ENDPOINT_PREFIX;
     ...
     * //	}
     **/
    public static String PLACE_INFO_BASIC_POSTFIX;
     ...
     * //	]
     **/
    public static String LIST_PLACES_FROM_AREA;
     ...
     **/
    public static String LIST_PLACES_BY_CITY;
     ...
     **/
    public static String LIST_PLACES_BY_COUNTRY;
     ...
     **/
    public static String LIST_PLACES_BY_CONTINENT;

    public static String CODE_CONTINENT_ASIA;
    public static String CODE_CONTINENT_AFRICA;
    public static String CODE_CONTINENT_NORTH_AMERICA;
    public static String CODE_CONTINENT_SOUTH_AMERICA;
    public static String CODE_CONTINENT_ANTARTICA;
    public static String CODE_CONTINENT_EUROPE;
    public static String CODE_CONTINENT_AUSTRALIA;
     ...
     * //	}
     **/
    public static String LIST_OF_CONTINENTS;
     ...
     * //	}
     **/
    public static String LIST_OF_COUNTRIES;
    public static String LIST_OF_COUNTRIES_AND_COORDINATES;
     ...
     * //	}
     **/
    public static String LIST_OF_LANGUAGES;
